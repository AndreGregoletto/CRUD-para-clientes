                ...
                <tr>
                    ...
                    <td>
                        <div class="row justify-content-center">
                            <div class="col-2">
                                <a href="{{ route('client.show', $client->id) }}" class="text-dark">
                            ...
                            <div class="col-2">
                                <a href="{{ route('client.edit', $client->id) }}" class="text-dark">
                            ...
                            <div class="col-2">
                                <a class="text-dark" style="cursor: pointer" onclick="destroy({{ $client->id }})">
